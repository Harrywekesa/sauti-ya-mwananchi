  ...
  return (
    <Card className="group relative flex flex-col h-full bg-white border border-slate-100 border-l-[5px] border-l-kenya-green hover:-translate-y-1.5 hover:shadow-xl hover:shadow-slate-100/80 transition-all duration-300 rounded-xl overflow-hidden">
      ...
      <CardContent className="px-6 py-2 space-y-4 flex-1">
        ...
        {/* Core Metadata tags: Single-line bullet separated layout */}
        <div className="flex items-center gap-2 text-[10.5px] text-gray-400 font-medium pt-1 truncate">
        ...
        {proposal.representative && (
          <div className="flex items-center gap-1.5 pt-2 border-t border-slate-100 text-[11px]">
            ...
            <strong className="text-gray-700 font-bold truncate">{proposal.representative}</strong>
          </div>
        )}
      </CardContent>
